class DrawingBoard {
    ...
    addEvent() {
        ...
        this.brushSliderEl.addEventListener(this.onChangeBrushSize.bind(this));
    ...
    onMouseDown(event) {
        ...
        const currentPosition = this.getMousePosition(event); //canvas의 x,y 좌표값 리턴 
    ...
    onClickUndo() {
        ...
        let previousDataUrl = this.undoArray.pop(); //가장 최근것 꺼냄 
